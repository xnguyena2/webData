...
<html style="background: white;">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="views/updatecompany.css">
    </head>
        ...
        <div>
            ...
            <div class="pull-right">
                <ol style="background-color: rgb(57, 171, 207);" class="breadcrumb">
                    <ul>
                        <li class="active"><a class="login-window" href="{{rootUrl+'mysite/demo_project/app/index.html'}}">Home Page</a></li>
                        <li ng-show="isLogin">
                            <a href="#">{{userName}} &#9662;</a>
                              <ul class="dropdown">
                                  <li><a href="{{rootUrl+'mysite/demo_project/app/mycredit.html'}}">My Credit</a></li>
                                  <li><a href="{{rootUrl+'mysite/demo_project/app/myfolder.html'}}">My Exports</a></li>
                                  <li><a href="{{rootUrl+'mysite/demo_project/app/mysetting.html'}}">Settings</a></li>
            ...
            <div id="myTabContent3" class="tab-content padding-10">
                <div class="tab-pane fade in active" id="home">
                    <ng-include src="updateCompanyForm"></ng-include>
                </div>
