myapp.controller('ContactCtrl', ['$scope', '$http', '$window', function ($scope, $http, $window ) {
        ...
        $scope.leftPanel = rootUrl+'mysite/demo_project/app/views/leftpanel.tpl.html';
        $scope.updateContactForm = rootUrl+'mysite/demo_project/app/views/contactupdateform.html';
        $scope.updateCompanyForm = rootUrl+'mysite/demo_project/app/views/companyupdateform.html';
        $scope.paypalSubcription = rootUrl+'mysite/demo_project/app/views/paypalsubcrision.html';
        $scope.paypalCalcleSubcription = rootUrl+'mysite/demo_project/app/views/paypalcancelsubcrision.html';
        ...
        $scope.contactClick = function($index){
            window.location.href = rootUrl+"mysite/demo_project/app/contact/"+$scope.token+"_"+$scope.contacts[$index]['ID']+".html";
        }
        ...
        $scope.showLoginForm = function () {
            window.location.href = rootUrl+"mysite/demo_project/app/login";            
        }
        
        $scope.showSignUpForm = function () {            
            window.location.href = rootUrl+"mysite/demo_project/app/login/#toregister";            
        }
        ...
        $scope.$watch('companyInfomation', function (newValue) {
            ...
            $scope.rootUrl = rootUrl;
            if (newValue !== undefined) {
                $http.get(rootUrl+"mysite/company.php",
                {
                ...
                .success(function (response) {
                    ...
                    $scope.mainContain = rootUrl+"mysite/demo_project/app/views/company-page.tpl.html";                    
                });
            }
        });
        ...
        $scope.$watch('contactInfomation', function (newValue) {
            ...
            $scope.rootUrl = rootUrl;
            if (newValue !== undefined) {
                $http.get(rootUrl+"mysite/contactinfo.php",
                {
        ...
        $scope.$watch('thankUpdate', function (newValue) {
            //console.log(newValue);
            if (newValue !== undefined) {
                $scope.mainContain = rootUrl+"mysite/demo_project/app/views/thank.html";         
            }
        });
        ...
        $scope.mainContain = rootUrl+"mysite/demo_project/app/views/list-contact.tpl.html";
        ...
        $scope.getFolderInfomation = function(){
            $.ajax({
                    ...
                    url: rootUrl+"mysite/folderInfo.php",
                    success: function (response) {
                        //console.log(response);
                        if(response !== '-1'){
                        ...
                        if(!$scope.firstLoadFolder)
                            $scope.mainContain = rootUrl+"mysite/demo_project/app/views/addToFolder.html";
        ...
        $scope.showContactInfomation = function ($name) {
            ...
            $scope.mainContain = rootUrl+"mysite/demo_project/app/views/contact-info.tpl.html";
        }
        
        $scope.companyClick = function($name){
            window.location.href = rootUrl+"mysite/demo_project/app/company/"+$name+".html";
        }
            ...
            if(isReset || $scope.searchAtBegin){
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        resultOnPage: $('#selectNumberDropDown :selected').text(),
                        searchName: searchName,
                        jobTitle: $scope.jobTitleFliter,
                        companyName: $scope.companyFliter
                    },
                    url: rootUrl+"mysite/search.php",
                    success: function (response) {
                        //console.log(response);
        ...
        $scope.loadState = function(){
            ...
            //if(canback === '1')
            {
                ...
                $scope.dropDownModel = $.cookie('resultOnPage');
                if($scope.dropDownModel)
                    if($scope.dropDownModel !== 'undefined')
                        $scope.dropDownModel = JSON.parse($scope.dropDownModel);
        ...
        $scope.showEmailAndPhone = function (folder) {
            ...
            if($scope.addedInfomation.length === 0){
                ...
                $.ajax({
                    ...
                    url: rootUrl+"mysite/addinfomation.php",
        ...
        $scope.goBackToExports = function(){
            $scope.myFolderPage = rootUrl+"mysite/demo_project/app/views/myfolder.html";            
        }
        
        $scope.myFolderPage = "views/myfolder.html";
        ...
        $scope.getCVSFile = function(folder, count, pages, isExport){
            {
                ...
                $.ajax({
                    ...
                    url: rootUrl+"mysite/getcvsfile.php",
                    success: function (msg) {
                        //$('.answer').html(msg);
                        //console.log(msg);
                        if (msg !== '-1'){
                            if(isExport){
                                ...
                                $scope.textResults = count+" contacts found for your advanced search!";
                                if(pages === 0){
                                    $scope.currentIndex = 1;
                                ...
                                $scope.myFolderPage = rootUrl+"mysite/demo_project/app/views/listexportcontact.html";
                                //$('#tableExample').DataTable();             
                                if(pages===0){
                                    $scope.previousPaging = 'disabled';
                                    $scope.nextPaging = '';
        ...
        $scope.showCompanyPage = function(){
            window.location.href = rootUrl+"mysite/demo_project/app/updatecompany.php?name="+decodeURIComponent($scope.company['NAME']);
        }        
