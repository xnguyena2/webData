...
<html class="no-js wf-sourcesanspro-i4-active wf-sourcesanspro-n3-active wf-sourcesanspro-n4-active wf-sourcesanspro-n6-active wf-sourcesanspro-n7-active wf-active csstransforms csstransforms3d csstransitions">
    ...
    <body id="WEB_BODY" class="ng-scope dontselect" ng-app="myapp" ng-controller="ContactCtrl" ng-init="contactInfomation='<?php echo rawurlencode(filter_input(INPUT_GET, 'info'));?>'">    
                        ...
                        <div class="container">
                            ...
                            <div class="rightSide-content">
                                <div class="breadcrumb-area" style="padding-bottom: 5px;border-bottom: 7px solid #16FFD4;margin-bottom: 8px;">
                                    <h1 style="text-align: left;padding: 0px;" class="breadcrumb-text ng-binding">{{'Infomation about '+contactInfo.FIRSTNAME +" "+contactInfo.LASTNAME}}</h1>
                                </div>
                                <div smart-include="../../app/views/contactinfo.html"></div>
                            </div>
                        </div>
                    </div>
                </div>
