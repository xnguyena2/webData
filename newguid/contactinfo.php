...
<section id="prices" class="light_section">
    <div class="container">
       ...
       <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
           <div class="bright">
              <h3><span class="bluee">Contact</span></h3>
                 <div class="row">
                         <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <div class="company">
                                 ...
                                 <p><a style="font-size: 25px;color: #0E56A2;font-weight: bold;" href="{{rootUrl}}mysite/newguid/company/{{company.NAME}}.html" ng-click="companyClick(company.NAME)">{{company.NAME}}</a></p>
                                 <p>{{company.ADDRESS}}</p>
                                 <p>{{company.PHONE}}</p>
                                 <p><a href="{{'http://'+company.URL}}">{{company.URL}}</a></p>
                                 <hr style="border-color:#e6e6e6"/>
                                 <p>Revenue: {{company.REVENUE}}</p>
                                 <p>Employee: {{company.SIZE}}</p>
                                 <p>{{company.INDUSTRIES}}</p>
                                 <p>Ownership: {{company.OWNERSHIP}}</p>
                            </div>
                         </div>
                         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <a href="#" ng-click="showContactUpdatePage()"><div class="updatebtn">Update Contact</div></a>

                            <a href="#" ng-click="showCompanyPage()" ><div class="updatebtn">Update Company Details</div></a>
                         </div>
                 </div>
           </div>  
       </div>
